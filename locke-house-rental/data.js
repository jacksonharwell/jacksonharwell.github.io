window.LOCKE_DATA={lastUpdated:"September 14, 2026",market:{sourceNote:"Public hotel-rate checks near Will Rogers; taxes and availability vary.",normalHotel:150,normalHouse:250,roomsReplaced:3,cleaningFee:175,airbnbGuestFee:.142},monthlyHotel:{"2026-09":150,"2026-10":175,"2026-11":170,"2026-12":165,"2027-01":185,"2027-02":175,"2027-03":165,"2027-04":170,"2027-05":185,"2027-06":170,"2027-07":160,"2027-08":155,"2027-09":165},events:[
{name:"Texas Classic",start:"2026-09-15",end:"2026-09-20",type:"horse",rate:300,icon:"♞",status:"confirmed"},
{name:"Rocket League World Championship",start:"2026-09-18",end:"2026-09-20",type:"city",rate:325,icon:"◆",status:"confirmed",citywide:true},
{name:"PBR Rattler Days",start:"2026-10-02",end:"2026-10-04",type:"bull",rate:300,icon:"★",status:"confirmed"},
{name:"Brooks & Dunn",start:"2026-10-09",end:"2026-10-10",type:"music",rate:275,icon:"♪",status:"confirmed"},
{name:"NRCHA Snaffle Bit Futurity",start:"2026-10-09",end:"2026-10-24",type:"horse",rate:325,icon:"♞",status:"confirmed"},
{name:"Red Steagall Cowboy Gathering",start:"2026-10-23",end:"2026-10-25",type:"horse",rate:300,icon:"♞",status:"confirmed"},
{name:"NCHA World Championship Futurity",start:"2026-11-16",end:"2026-12-12",type:"horse",rate:325,icon:"♞",status:"confirmed"},
{name:"Critical Role Live",start:"2026-12-03",end:"2026-12-03",type:"music",rate:300,icon:"♪",status:"confirmed"},
{name:"for KING + COUNTRY",start:"2026-12-05",end:"2026-12-05",type:"music",rate:275,icon:"♪",status:"confirmed"},
{name:"Flatland Cavalry — NYE",start:"2026-12-31",end:"2026-12-31",type:"music",rate:350,icon:"♪",status:"confirmed"},
{name:"Fort Worth Stock Show & Rodeo",start:"2027-01-15",end:"2027-02-06",type:"cattle",rate:375,icon:"●",status:"confirmed",citywide:true},
{name:"NRCHA Celebration of Champions",start:"2027-02-13",end:"2027-02-27",type:"horse",rate:325,icon:"♞",status:"confirmed"},
